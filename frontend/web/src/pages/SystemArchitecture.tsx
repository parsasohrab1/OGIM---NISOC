...
import { FIELD } from '../data/marunField'
...
const SECTIONS: Array<{ id: SectionId; title: string; titleEn: string; items: Item[] }> = [
  {
    ...
    items: [
      ...
      { name: 'فشار دالیز', nameEn: 'Casing Pressure', detail: 'فشار دالیز/annulus — psi' },
  ...
  },
  {
    ...
    items: [
      { name: 'وضعیت زنده ۲۴ چاه مارون', detail: 'نفت، گاز، آب، درصد آب تولیدی، سلامت، ریسک تجهیزات' },
      ...
      { name: 'داده دوقلوی دیجیتال سه‌بعدی', detail: 'مسیر چاه، فشار/دما عمقی، جلوگیری‌کننده از فوران، دالیز' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'جدول و کارت چاه‌ها', detail: 'وضعیت هر MN-01…24' },
